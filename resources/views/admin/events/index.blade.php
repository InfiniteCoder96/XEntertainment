                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a type="button" name="edit" class="btn btn-sm btn-warning" href="{{route('events.edit', $event->id)}}">Edit</a>
                                <button type="button" name="delete" class="btn btn-sm btn-danger delete">Delete</button>

                                <form action="{{ route('events.destroy', $event->id) }}" method="POST" style="display:none">
                                    {{ method_field('DELETE') }}
                                    {{ csrf_field() }}

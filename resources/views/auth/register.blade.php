...
<body style="background-color:#454444">
    ...
    <section class="w3l-workinghny-form">
        ...
        <div class="workinghny-form-grid">
            <div class="wrapper">
                <div class="logo">
                    <h1><a class="brand-logo" href="index.html" style="color:#FE5518"><span>X Entertainment</span> Sign Up</a></h1>
                ...
                <div class="workinghny-block-grid">
                    <div class="workinghny-left-img align-end">
                        <img src="{{ asset('auth/images/register_img.svg') }}" class="img-responsive" alt="img" />
                    </div>
                        ...
                        <div class="login-form-content">
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group row">
                                    <label for="name" style="color: white;" class="col-md-4 col-form-label text-md-right text-white">{{ __('Name') }}</label>
                                ...
                                <p class="already" style="color: white;">Already have an account? <a href="{{route('login')}}" style="color: #FE5518;">Sign In</a></p>
                            </form>
